...
export const LiveStoreDevtoolsPanel = (_props: TanStackDevtoolsPluginProps): React.ReactElement => {
    ...
    <div style={containerStyle}>
      ...
      <div style={scrollStyle}>
            ...
            {sync ? (
              <div style={{ ...reset, display: "flex", flexDirection: "column", gap: 4 }}>
                <div style={{ ...reset, display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  <span style={{ ...inlineStyle, color: colors.textMuted }}>
                ...
                <div style={{ ...reset, color: colors.textMuted, fontSize: 11 }}>
                  ...
                  {" · "}
                  upstream:{" "}
                  <code style={{ ...reset, color: colors.text }}>{sync.upstreamHead}</code>
                </div>
              </div>
            ) : (
              <span style={{ ...reset, color: colors.textDim }}>
        ...
        <section style={sectionStyle}>
          ...
          {collections.size === 0 ? (
            <div style={{ ...cardStyle, color: colors.textDim }}>(none registered)</div>
          ) : (
        ...
        <section style={sectionStyle}>
          ...
          {log.length === 0 ? (
            <div style={{ ...cardStyle, color: colors.textDim }}>(no commits yet)</div>
          ) : (
            log.map((entry, i) => (
