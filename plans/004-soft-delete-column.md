...
> in `plans/README.md`.
>
> **Drift check (run first)**: `git diff --stat a46750d8..HEAD -- packages/livestore-prisma/src/createLiveStoreDb.ts packages/livestore-tanstack-db/src/useTable.ts packages/livestore-tanstack-db/src/mutations.ts`
