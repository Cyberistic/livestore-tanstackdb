...
> in `plans/README.md`.
>
> **Drift check (run first)**: `git diff --stat 4bbb4e26..HEAD -- packages/livestore-prisma/dist packages/livestore-prisma/package.json packages/livestore-prisma/tsconfig.build.json`
...
- **Depends on**: none
- **Category**: direction
- **Planned at**: commit `4bbb4e26`, 2026-07-14
- **Issue**: omit
