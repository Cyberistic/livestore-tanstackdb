...
> in `plans/README.md`.
>
> **Drift check (run first)**: `git diff --stat 3263a9de..HEAD -- packages/livestore-prisma/dist packages/livestore-prisma/package.json packages/livestore-prisma/tsconfig.build.json`
