...
> in `plans/README.md`.
>
> **Drift check (run first)**: `git diff --stat 51c881c4..HEAD -- packages/livestore-prisma/package.json packages/livestore-tanstack-db/package.json examples/spa/package.json examples/tanstack-start-orpc/package.json bun.lock`
