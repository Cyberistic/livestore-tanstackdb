...
> in `plans/README.md`.
>
> **Drift check (run first)**: `git diff --stat 6962dc10..HEAD -- packages/livestore-prisma/package.json packages/livestore-tanstack-db/package.json examples/spa/package.json examples/tanstack-start-orpc/package.json bun.lock`
...
- **Planned at**: commit `6962dc10`, 2026-07-14
- **Issue**: omit
